...
<html>
<head>
    <title>{title} | Document Wizard</title>
    ...
    <style>
        ...
        .result-card {{
            ...
            padding: 1.5rem;
            margin: 2rem 0;
            border: 2px solid #0d96c1;
            box-shadow: 0 4px 12px rgba(13, 150, 193, 0.1);
            display: block;
            position: relative;
            z-index: 1;
            clear: both;
        ...
        /* Make sure main content flows properly */
        main.container {{
            display: block;
            position: relative;
            z-index: 1;
...
<nav style="padding: 1rem 0; border-bottom: 1px solid #e5e7eb;">
    <div class="container">
        ...
        <span style="float: right;">
            ...
            <a href="/wizard">Document Wizard</a>
        </span>
    </div>
</nav>
...
<footer style="text-align: center; padding: 2rem; color: #6b7280; border-top: 1px solid #e5e7eb;">
    <p>Document Wizard • AI-powered document translation for everyday people</p>
</footer>
</body>
</html>'''
